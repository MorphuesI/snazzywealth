...
$fid=$_POST['frm_id'] ;
mysqli_query($con,"update ticket set distributor_remark='$distributorremark',status='closed' where id='$fid'");
...
<meta charset="utf-8" />
<title>Distributor | Manage Tickets</title>
  ...
  <div class="page-content">
    ...
    <div class="content">
      ...
      <div class="page-title"> 
        <a href="dashboard.php"> <i class="icon-custom-left"></i> </a>
