...
if(isset($_POST['update']))
{
	...
	$a=mysqli_query($con,"update distributor set name='$name',mobile='$mobile',gender='$gender',alt_email='$aemail',city='$city',country='$country',address='$address' where email='".$_SESSION['login']."'");
if($a)
{
...
<meta charset="utf-8" />
<title>Snazzy Wealth | Distributor Profile</title>
...
<?php
$query=mysqli_query($con,"select * from distributor where email='".$_SESSION['login']."'");
                                   ...
                                   <div class="form-group">
									   ...
									   <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text"  name="city" value="<?php echo $row['city'];?>"  maxlength="10" class="form-control"/>
                                            </div>                                            
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text"  name="country" value="<?php echo $row['country'];?>"  maxlength="10" class="form-control"/>
                                            </div>                                            
