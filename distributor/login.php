...
{
$ret=mysqli_query($con,"SELECT * FROM distributor WHERE email='".$_POST['email']."' and password='".$_POST['password']."'");
...
<div class="container">
  <div class="row login-container column-seperation">  
        <div class="col-md-5 col-md-offset-1">
          ...
          <p>
            <a href="registration.php">Sign up Now!</a> If you don't have an account already.</p>
          <br>
