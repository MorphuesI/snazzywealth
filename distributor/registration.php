...
if(isset($_POST['submit']))
{
  ...
  $country=$_POST['country'];
	$gender=$_POST['gender'];
	$query=mysqli_query($con,"select email from distributor where email='$email'");
  ...
  echo "<script>window.location.href='registration.php'</script>";
	...
	{
 mysqli_query($con,"insert into distributor(name,email,password,mobile,city,country,gender) values('$name','$email','$password','$mobile','$city','$country','$gender')");
...
<meta charset="utf-8" />
<title>Snazzy Wealth | Registration</title>
...
<div class="container">
  <div class="row login-container column-seperation">  
        <div class="col-md-5 col-md-offset-1">
          <h2>Sign in to Snazzy Wealth</h2>
          <p>            <a href="login.php">Sign in Now!</a> If you already have an account.</p>
          <br>
