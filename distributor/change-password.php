...
{
 $sql=mysqli_query($con,"SELECT password FROM  distributor where password='".$_POST['oldpass']."' && email='".$_SESSION['login']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($con,"update  distributor set password='".$_POST['newpass']."' where email='".$_SESSION['login']."'");
...
<meta charset="utf-8" />
<title>Snazzy Wealth | Change Password</title>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                               ...
                               <div class="form-group">                                        
                                ...
                                <div class="panel-footer" style="width: 450px;margin: 0 auto">
