...
{
	$msg=mysqli_query($con,"update ticket set remark='".$_POST['adminremark']."' where id='".$_GET['id']."'");
	if($msg)
	{
	echo "<script>alert('Remark Updated');</script>";
	echo "<script>window.location = 'manage-quotes.php';</script>";	
	}
}
?><!DOCTYPE html>
<html>
    ...
    <div class="content">                           
     <ul class="breadcrumb">
   	...
   	<div class="page-title">		
		<a href="manage-tickets.php">  <i class="icon-custom-left"></i></a>
		<h3>Quote Details</h3>	
	</div>
 	<?php
    $ret=mysqli_query($con,"select * from ticket where id='".$_GET['id']."'");
