...
if(isset($_POST['update']))
{
	...
	$a=mysqli_query($con,"update user set name='$name',mobile='$mobile',gender='$gender',alt_email='$aemail',city='$city',country='$country',address='$address' where email='".$_SESSION['login']."'");
if($a)
{
...
<meta charset="utf-8" />
<title>Snazzy Wealth | User Profile</title>
